...
.error {
	...
	<h4>회원가입</h4>
	<form:form action="${pageContext.request.contextPath }/member/memberInsert.do" modelAttribute="member" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				<th>회원아이디</th>
				<td>
					<form:input path="memId"  maxlength="15" class="form-control" />
