...
<body>
<div>
	<h4>요청 컨텐츠의 MIME : request : Content-Type header</h4>
	<input type="radio" name="contentType" value="application/json"/>JSON
	<input type="radio" name="contentType" value="application/x-www-form-urlencoded" checked />Parameter
</div>
<div>
...
<form id="calForm" action="<%=request.getContextPath() %>/calculator/case3" method="post">
	...
	$("#calForm").on("submit", function(event){
		...
		$.ajax({
			...
			if(jqXHR.responseJSON){
				resultArea.text(resp['calculator']['expression']);
