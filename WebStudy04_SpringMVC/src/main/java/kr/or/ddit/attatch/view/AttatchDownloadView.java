...
public class AttatchDownloadView extends AbstractView {
	...
	public static final String DOWNTARGETNAME = "downloadTarget";
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		AttatchFileVO atchFile = (AttatchFileVO) model.get(DOWNTARGETNAME);
		String originalfilename = atchFile.getAtchOrginName();
		String saveName = atchFile.getAtchSaveName();
